...
void RLCustomHud::onLoad()
{
	...
	colormap = ColorMap::LoadColorMap(ColorMap::ColorMapName::linear_bgy_10_95_c74_n256);
...
void RLCustomHud::RenderImGui()
{
	...
	drawList->AddPolyline(
		...
		ColorMap::SampleColorMap(airRollLeftValue, colormap),
		false,
		thickness);
	...
	drawList->AddPolyline(
		...
		ColorMap::SampleColorMap(airRollRightValue, colormap),
		false,
		thickness);
	...
	drawList->AddLine(
		...
		ColorMap::SampleColorMap(rightValue, colormap),
		thickness);
	...
	drawList->AddLine(
		...
		ColorMap::SampleColorMap(leftValue, colormap),
		thickness);
	...
	drawList->AddLine(
		...
		ColorMap::SampleColorMap(downValue, colormap),
		thickness);
	...
	drawList->AddLine(
		...
		ColorMap::SampleColorMap(upValue, colormap),
		thickness);
	...
	drawList->AddLine(
		...
		ColorMap::SampleColorMap(throttleValue, colormap),
		thickness);
